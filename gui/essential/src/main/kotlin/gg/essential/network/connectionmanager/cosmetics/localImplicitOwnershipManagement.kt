...
import gg.essential.cosmetics.ImplicitOwnershipCriterion
import gg.essential.cosmetics.ImplicitOwnershipId

fun CosmeticsDataWithChanges.registerImplicitOwnership(
    id: ImplicitOwnershipId,
    cosmetics: List<String>,
    criterion: ImplicitOwnershipCriterion,
) {
